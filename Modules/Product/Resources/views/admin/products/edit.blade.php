                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('place::admin.products.partials.edit-fields-localized', ['lang' => $locale])
                        </div>
                    @endforeach
                </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                <div class="box-body">
                    @include('place::admin.products.partials.edit-fields')
                </div>
