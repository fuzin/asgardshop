...
<div class="box-body">
    <div class='form-group{{ $errors->has("zip") ? ' has-error' : '' }}'>
        ...
        {!! Form::text("zip", old("zip"), ['class' => 'form-control slug', 'data-zip' => 'target', 'placeholder' => trans('place::place.form.zip')]) !!}
        {!! $errors->first("zip", '<span class="help-block">:message</span>') !!}
    </div>
    <div class='form-group{{ $errors->has("city") ? ' has-error' : '' }}'>
        {!! Form::label("city", trans('place::places.form.city')) !!}
        {!! Form::text("city", old("city"), ['class' => 'form-control slug', 'data-city' => 'target', 'placeholder' => trans('place::place.form.city')]) !!}
        {!! $errors->first("city", '<span class="help-block">:message</span>') !!}
    </div>
    <div class='form-group{{ $errors->has("streetName") ? ' has-error' : '' }}'>
        {!! Form::label("streetName", trans('place::places.form.streetName')) !!}
        {!! Form::text("streetName", old("streetName"), ['class' => 'form-control slug', 'data-streetName' => 'target', 'placeholder' => trans('place::place.form.streetName')]) !!}
    ...
    <div class='form-group{{ $errors->has("streetNumber") ? ' has-error' : '' }}'>
        ...
        {!! Form::number("streetNumber", old("streetNumber"), ['class' => 'form-control slug', 'data-streetNumber' => 'target', 'placeholder' => trans('place::place.form.streetNumber')]) !!}
    ...
    <div class='form-group{{ $errors->has("addressInfo") ? ' has-error' : '' }}'>
        ...
        {!! Form::text("addressInfo", old("addressInfo"), ['class' => 'form-control slug', 'data-addressInfo' => 'target', 'placeholder' => trans('place::place.form.addressInfo')]) !!}
