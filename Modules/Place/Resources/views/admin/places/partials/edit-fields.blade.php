<div class="box-body">
    ...
    <div class="box-body">
        <div class='form-group{{ $errors->has("{$lang}.name") ? ' has-error' : '' }}'>
            ...
            {!! Form::text("{$lang}[name]", old("{$lang}.name", $old), ['class' => 'form-control', 'data-slug' => 'source', 'placeholder' => trans('place::place.form.name')]) !!}
        ...
        <div class='form-group{{ $errors->has("{$lang}.slug") ? ' has-error' : '' }}'>
            ...
            {!! Form::text("{$lang}[slug]", old("{$lang}.slug", $old), ['class' => 'form-control slug', 'data-slug' => 'target', 'placeholder' => trans('place::place.form.slug')]) !!}
            ...
            <div style="height: 0px;" id="collapseTwo-{{$lang}}" class="panel-collapse collapse">
                <div class="box-body">
                    <div class='form-group{{ $errors->has("{$lang}[meta_title]") ? ' has-error' : '' }}'>
                        ...
                        {!! Form::text("{$lang}[meta_title]", old("$lang.meta_title", $old), ['class' => "form-control", 'placeholder' => trans('place::place.form.meta_title')]) !!}
            ...
            <div style="height: 0px;" id="collapseFacebook-{{$lang}}" class="panel-collapse collapse">
                <div class="box-body">
                    <div class='form-group{{ $errors->has("{$lang}[og_title]") ? ' has-error' : '' }}'>
                        ...
                        {!! Form::text("{$lang}[og_title]", old("{$lang}.og_title", $old), ['class' => "form-control", 'placeholder' => trans('place::place.form.og_title')]) !!}
