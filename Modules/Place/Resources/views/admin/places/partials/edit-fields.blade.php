...
<div class="box-body">
    <div class='form-group{{ $errors->has("zip") ? ' has-error' : '' }}'>
        ...
        {!! Form::text("zip", old("zip", $old), ['class' => 'form-control slug', 'data-zip' => 'target', 'placeholder' => trans('place::place.form.zip')]) !!}
    ...
    <div class='form-group{{ $errors->has("city") ? ' has-error' : '' }}'>
        ...
        {!! Form::text("city", old("city", $old), ['class' => 'form-control slug', 'data-city' => 'target', 'placeholder' => trans('place::place.form.city')]) !!}
    ...
    <div class='form-group{{ $errors->has("streetName") ? ' has-error' : '' }}'>
        ...
        {!! Form::text("streetName", old("streetName", $old), ['class' => 'form-control slug', 'data-streetName' => 'target', 'placeholder' => trans('place::place.form.streetName')]) !!}
    ...
    <div class='form-group{{ $errors->has("streetNumber") ? ' has-error' : '' }}'>
        ...
        {!! Form::number("streetNumber", old("streetNumber", $old), ['class' => 'form-control slug', 'data-streetNumber' => 'target', 'placeholder' => trans('place::place.form.streetNumber')]) !!}
    ...
    <div class='form-group{{ $errors->has("addressInfo") ? ' has-error' : '' }}'>
        ...
        {!! Form::text("addressInfo", old("addressInfo", $old), ['class' => 'form-control slug', 'data-addressInfo' => 'target', 'placeholder' => trans('place::place.form.addressInfo')]) !!}
